...
\KwResult{\textit{getEntities(x,y,z)} Returns an array results $x$, consisting of entities}
\myhelper{\hspace*{5mm}present in documents in array $x$ from range $y$ to $z$}
